...
CREATE TABLE IF NOT EXISTS "public"."divisiones" (
    ...
    "codigo_division" "text",
    "is_active" boolean DEFAULT true
);


ALTER TABLE "public"."divisiones" OWNER TO "postgres";


ALTER TABLE "public"."divisiones" ALTER COLUMN "id_division" ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME "public"."divisiones_id_division_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."divisiones"
    ADD CONSTRAINT "divisiones_pkey" PRIMARY KEY ("id_division");
...
ALTER TABLE ONLY "public"."departamento"
    ADD CONSTRAINT "departamento_division_id_fkey" FOREIGN KEY ("division_id") REFERENCES "public"."divisiones"("id_division");
...
GRANT ALL ON TABLE "public"."divisiones" TO "anon";
GRANT ALL ON TABLE "public"."divisiones" TO "authenticated";
GRANT ALL ON TABLE "public"."divisiones" TO "service_role";



GRANT ALL ON SEQUENCE "public"."divisiones_id_division_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."divisiones_id_division_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."divisiones_id_division_seq" TO "service_role";
